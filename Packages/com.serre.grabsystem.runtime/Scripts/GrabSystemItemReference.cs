...
{
    [Serializable]
    public sealed class GrabSystemAttachPointSettings
    {
        public Transform SourceTransform;
        public Vector3 PositionOffset;
        public Vector3 RotationOffset;
        public GrabSystemAttachPointMethod AttachmentMethod;
    ...
    [Serializable]
    public sealed class GrabSystemContactSettings
    {
    ...
    [Serializable]
    public sealed class GrabSystemItemSettings
    {
        ...
        public GrabSystemAttachPointSettings[] AttachPoints = new GrabSystemAttachPointSettings[AttachPointCount];
        public GrabSystemContactSettings[] Contacts = new GrabSystemContactSettings[ContactCount];
        ...
        {
            AttachPoints = Resize(AttachPoints, AttachPointCount, () => new GrabSystemAttachPointSettings());
            Contacts = Resize(Contacts, ContactCount, () => new GrabSystemContactSettings());
    ...
    public enum GrabSystemAttachPointMethod
    {
        BoneProxy,
        ParentConstraint,
    }
    ...
    public sealed class GrabSystemItemReference : MonoBehaviour
#if VRC_SDK_VRCSDK3
        , IEditorOnly
#endif
    {
        ...
        private GameObject generatedGrabSystem;

        [SerializeField, HideInInspector]
        private GrabSystemItemSettings itemSettings = new GrabSystemItemSettings();

        public GameObject GeneratedGrabSystem => generatedGrabSystem;
        public Transform GrabSystemRoot => generatedGrabSystem != null ? generatedGrabSystem.transform : null;
        public GrabSystemItemSettings ItemSettings
        {
            get
            {
                itemSettings ??= new GrabSystemItemSettings();
                itemSettings.EnsureInitialized();
                return itemSettings;
            }
        }

        public void SetGeneratedGrabSystem(GameObject value)
        {
            generatedGrabSystem = value;
        }

        public void SetItemSettings(GrabSystemItemSettings value)
        {
            itemSettings = value ?? new GrabSystemItemSettings();
            itemSettings.EnsureInitialized();
        }

        [SerializeField, HideInInspector]
        private int giSlot = -1;
        ...
        [SerializeField]
        private GrabSystemAttachPointMethod ap00AttachmentMethod;

        [SerializeField]
        private GrabSystemAttachPointMethod ap01AttachmentMethod;

        [SerializeField]
        private GrabSystemAttachPointMethod ap02AttachmentMethod;

        [SerializeField]
        private GrabSystemAttachPointMethod ap03AttachmentMethod;

        [SerializeField]
        private GrabSystemAttachPointMethod ap04AttachmentMethod;

        [SerializeField]
        private GrabSystemAttachPointMethod ap05AttachmentMethod;

        [SerializeField]
        private GrabSystemAttachPointMethod ap06AttachmentMethod;

        [SerializeField]
        private Transform giItemSize;

        [SerializeField]
        private bool giItemSizeEditing;

        [SerializeField]
        private bool giItemSizeContactEditing;

        [SerializeField]
        private bool giInputContactEditing;

        [SerializeField]
        private bool giOutputContactEditing;
        ...
        public Transform GIItemSize => giItemSize;
        public bool GIItemSizeEditing => giItemSizeEditing;
        public bool GIItemSizeContactEditing => giItemSizeContactEditing;
        public bool GIInputContactEditing => giInputContactEditing;
        public bool GIOutputContactEditing => giOutputContactEditing;
        ...
        public void SetGISlot(int value)
        {
            giSlot = Mathf.Clamp(value, 0, 15);
        }
        ...
        public void SetGIItemSizeEditing(bool value)
        {
            giItemSizeEditing = value;
        }

        public void SetGIItemSizeContactEditing(bool value)
        {
            giItemSizeContactEditing = value;
        }

        public void SetGIInputContactEditing(bool value)
        {
            giInputContactEditing = value;
        }

        public void SetGIOutputContactEditing(bool value)
        {
            giOutputContactEditing = value;
        }
        ...
        public GrabSystemAttachPointMethod GetAttachPointMethod(string attachPointName)
        {
            switch (attachPointName)
            {
                ...
                default: return GrabSystemAttachPointMethod.BoneProxy;
            }
        }

        public void SetAttachPointMethod(string attachPointName, GrabSystemAttachPointMethod value)
        {
            switch (attachPointName)
            {
